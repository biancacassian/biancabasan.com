    ...
    return (
        <>
            ...
            <div className={`${contentStyles['content__double-col-right']} ${empathizeStyles['empathize__col']}`}>
                ...
                <p>According to the data <b>90% of users succeed in the process with just 10% abandoning</b>, and users generally find it to be easy and fast. What the current onboarding is doing is <b>the set up moment</b>, creating an account, granting permission, asking for personal information, these actions are necessary however they don’t provide immediate benefits.</p>
                <p><b>What I noticed that was missing from the current onboarding was communicating the value that I get as a user from using Giftd.</b> Since the product is constantly evolving, together with the founder we examined the present flow to seek for opportunities and eliminate stages that are not essential. Here is what we found:</p>
