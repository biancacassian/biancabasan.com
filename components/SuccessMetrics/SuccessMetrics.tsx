...
import successMetrics1 from '../../public/assets/images/content/success-metrics/success-metrics-1.svg';
import successMetrics2 from '../../public/assets/images/content/success-metrics/success-metrics-2.svg';
  ...
  return (
    <>
      ...
      <div className={contentStyles['content__double-col-right']}>
        ...
        <p><b>01.</b> Number of  downloads as an indicator of acquisition.</p>
        <p><b>02.</b> Monthly active users as an indicator of usage and retention.</p>
        <p><b>03.</b> How many save, book exhibits and read the blog section as an indicator of engagement.</p>
      </div>
      ...
      <div className={successMetricsStyles['success-metrics__image']}>
        <ImageView image={successMetrics1} imageAltText="Success Metrics" imageDisplay={ImageDisplay.inline}/>
      </div>
      ...
      <div className={successMetricsStyles['success-metrics__image']}>
        <ImageView image={successMetrics2} imageAltText="Success Metrics" imageDisplay={ImageDisplay.inline}/>
      </div>
