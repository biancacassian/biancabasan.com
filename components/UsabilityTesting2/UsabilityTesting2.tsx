  ...
  return (
    <>
      ...
      <div className={contentStyles['content__double-col-right']}>
        ...
        <p>All the participants completed all the tasks in under 5 minutes, and all participants commented on the <b>design’s friendliness, concise presentation of information, the clean minimalist design and appreciated that it was pretty easy to accomplish their tasks.</b></p>
      </div>
      ...
      <p className={contentStyles['content__double-col-right']}><b>A major insight</b> was that the “Buy ticket” button was directing the user to the payment screen offering no option for choosing a guide before purchasing the ticket.</p>
      <h1 className={contentStyles['content__double-col-left']}>Solution</h1>
      ...
      <div className={contentStyles['content__double-col-right']}>
        <p>During the usability test I also did a <b>A/B testing</b>, asking participant which button they prefer and why.</p>
        <p><b>Does creating the feeling of urgency make the participants want to book the tour?</b></p>
      ...
      <p className={contentStyles['content__double-col-right']}>The majority liked the second option because: <b>“It's friendlier and provides more information on what I need to know before booking.”</b></p>
    </>
  )
}
