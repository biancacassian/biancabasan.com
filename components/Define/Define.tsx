...
import define1 from '../../public/assets/images/content/define/define1.jpg';
import define2 from '../../public/assets/images/content/define/define2.jpg';
  ...
  return (
    <>
      ...
      <div className={contentStyles['content__double-col-right']}>
        ...
        <p>Moving forward I changed the user personas from stereotypes to archetypes and concentrated on psychographics: motivations, pain points and needs.</p>
      </div>
